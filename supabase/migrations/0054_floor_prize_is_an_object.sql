-- ---------------------------------------------------------------------------
--  0054 — the consolation prize must be a THING
--
--  The floor anchor exists on the argument that "you got junk" beats "+5 scrap
--  coins": a cheap object still puts something in your hands. But its pool was
--  every cheap row from the tiers below, INCLUDING house credit, free spins and
--  discount vouchers -- and those carry far more stock than the one-off junk
--  beside them, while the floor draw is stock-weighted.
--
--  So they were winning it. Measured on a freshly restocked catalogue: 75% of
--  every tier_1 roll and 61% of every tier_3 roll came back as a promise rather
--  than an object. That is both the "free spins show up far too often"
--  complaint and the "floor junk odds seem too high" one, from one cause.
--
--  Reward rows still drop normally from their own tier's prize pool, priced
--  exactly as before. They are simply no longer what a box hands you when it
--  has nothing else to give.
--
--  Both predicates move together: box_odds decides what the floor is WORTH and
--  publishes the per-item odds, open_box decides what it actually AWARDS.
-- ---------------------------------------------------------------------------
