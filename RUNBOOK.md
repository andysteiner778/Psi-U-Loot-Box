...
- **Physical Pickup Only**: Remind winners that Purple (Restricted), Pink (Covert), and Gold (PC Shard/Gaming PC) items cannot be scrapped — they must be picked up from Andy in Japan.
